...
try:
	...
	pass
class ATC_Operator(ControlSurface):
	def __init__(self, c_instance):
		super(ATC_Operator, self).__init__(c_instance)
	...
	def _inputs(self):
		self.input_map = [
			"midi_note_ch_15_val_1",
			"midi_note_ch_15_val_2",
			"midi_note_ch_15_val_3",
			"midi_note_ch_15_val_4"]
		self.midi_note_ch_15_val_1 = ConfigurableButtonElement(True, MIDI_NOTE_TYPE, 15, 1)
		self.midi_note_ch_15_val_1.set_on_off_values(self.led_on, self.led_off)
		self.midi_note_ch_15_val_1.add_value_listener(self.placehold_listener,identify_sender= False)
		self.midi_note_ch_15_val_1.pre_val = 0
		self.midi_note_ch_15_val_1.cur_val = 0
		self.midi_note_ch_15_val_2 = ConfigurableButtonElement(True, MIDI_NOTE_TYPE, 15, 2)
		self.midi_note_ch_15_val_2.set_on_off_values(self.led_on, self.led_off)
		self.midi_note_ch_15_val_2.add_value_listener(self.placehold_listener,identify_sender= False)
		self.midi_note_ch_15_val_2.pre_val = 0
		self.midi_note_ch_15_val_2.cur_val = 0
		self.midi_note_ch_15_val_3 = ConfigurableButtonElement(True, MIDI_NOTE_TYPE, 15, 3)
		self.midi_note_ch_15_val_3.set_on_off_values(self.led_on, self.led_off)
		self.midi_note_ch_15_val_3.add_value_listener(self.placehold_listener,identify_sender= False)
		self.midi_note_ch_15_val_3.pre_val = 0
		self.midi_note_ch_15_val_3.cur_val = 0
		self.midi_note_ch_15_val_4 = ConfigurableButtonElement(True, MIDI_NOTE_TYPE, 15, 4)
		self.midi_note_ch_15_val_4.set_on_off_values(self.led_on, self.led_off)
		self.midi_note_ch_15_val_4.add_value_listener(self.placehold_listener,identify_sender= False)
		self.midi_note_ch_15_val_4.pre_val = 0
		self.midi_note_ch_15_val_4.cur_val = 0
	def _mode1(self):
		...
		clips = []
		stop_all = self.midi_note_ch_15_val_1
		stop_tracks = []
		scene_launch = [self.midi_note_ch_15_val_2]
		...
		self.midi_note_ch_15_val_4.add_value_listener(self.midi_note_ch_15_val_4_mode1_listener,identify_sender= False)
		self.midi_note_ch_15_val_3.add_value_listener(self.midi_note_ch_15_val_3_mode1_listener,identify_sender= False)
		self.midi_note_ch_15_val_2.add_value_listener(self.midi_note_ch_15_val_2_mode1_listener,identify_sender= False)
		self._mode1_configs()
	...
	def _remove_mode1(self):
		...
		self.midi_note_ch_15_val_4.remove_value_listener(self.midi_note_ch_15_val_4_mode1_listener)
		self.midi_note_ch_15_val_3.remove_value_listener(self.midi_note_ch_15_val_3_mode1_listener)
		self.midi_note_ch_15_val_2.remove_value_listener(self.midi_note_ch_15_val_2_mode1_listener)
		self._remove_mode1_led_listeners()
	def midi_note_ch_15_val_4_mode1_listener(self, value):
		self.midi_note_ch_15_val_4.cur_val = value 
		if not hasattr(self.midi_note_ch_15_val_4, "pre_val"):
			self.midi_note_ch_15_val_4.pre_val = None
		if not hasattr(self.midi_note_ch_15_val_4, "prev_press_time"):
			self.midi_note_ch_15_val_4.prev_press_time = time.time()
		self.pick_brain(self.session_box_navigation_next_id_3)
		self.midi_note_ch_15_val_4.pre_val = value
		self.midi_note_ch_15_val_4.prev_press_time = time.time()
	def midi_note_ch_15_val_3_mode1_listener(self, value):
		self.midi_note_ch_15_val_3.cur_val = value 
		if not hasattr(self.midi_note_ch_15_val_3, "pre_val"):
			self.midi_note_ch_15_val_3.pre_val = None
		if not hasattr(self.midi_note_ch_15_val_3, "prev_press_time"):
			self.midi_note_ch_15_val_3.prev_press_time = time.time()
		self.pick_brain(self.session_box_navigation_prev_id_7)
		self.midi_note_ch_15_val_3.pre_val = value
		self.midi_note_ch_15_val_3.prev_press_time = time.time()
	def midi_note_ch_15_val_2_mode1_listener(self, value):
		self.midi_note_ch_15_val_2.cur_val = value 
		if not hasattr(self.midi_note_ch_15_val_2, "pre_val"):
			self.midi_note_ch_15_val_2.pre_val = None
		if not hasattr(self.midi_note_ch_15_val_2, "prev_press_time"):
			self.midi_note_ch_15_val_2.prev_press_time = time.time()
		self.pick_brain(self.session_box_navigation_advance_id_5)
		self.midi_note_ch_15_val_2.pre_val = value
		self.midi_note_ch_15_val_2.prev_press_time = time.time()
	def _mode1_configs(self):
		self.mode_1_configs_map = [
			"session_box_navigation_next_id_3",
			"session_box_navigation_prev_id_7",
			"session_box_navigation_advance_id_5"]
		self.session_box_navigation_next_id_3 = {}
		self.session_box_navigation_next_id_3["attached_to"] = "midi_note_ch_15_val_4"
		self.session_box_navigation_next_id_3["module"] = "self"
		self.session_box_navigation_next_id_3["element"] = "scroll_sess_offset"
		self.session_box_navigation_next_id_3["output_type"] = "func"
		self.session_box_navigation_next_id_3["func_arg"] = "cnfg"
		self.session_box_navigation_next_id_3["tracks_scenes"] = "scenes"
		self.session_box_navigation_next_id_3["ui_listener"] = "offset"
		self.session_box_navigation_next_id_3["feedback_brain"] = "feedback_sessbox_nav"
		self.session_box_navigation_next_id_3["ctrl_type"] = "increment"
		self.session_box_navigation_next_id_3["enc_first"] = 127
		self.session_box_navigation_next_id_3["enc_second"] = 0
		self.session_box_navigation_next_id_3["steps"] = 1
		self.session_box_navigation_next_id_3["switch_type"] = "momentary"
		self.session_box_navigation_next_id_3["LED_mapping_type_needs_feedback"] = "1"
		self.session_box_navigation_next_id_3["LED_feedback"] = "default"
		self.session_box_navigation_next_id_3["LED_feedback_active"] = "1"
		self.session_box_navigation_next_id_3["LED_on"] = "127"
		self.session_box_navigation_next_id_3["LED_off"] = "0"
		self.session_box_navigation_next_id_3["LED_send_feedback_to_selected"] = ["midi_note_ch_15_val_4"]
		self.session_box_navigation_next_id_3["json_id"] = 3
		self.session_box_navigation_next_id_3["mapping_name"] = "Session Box Navigation NEXT"
		self.session_box_navigation_next_id_3["mapping_type"] = "Session Box Navigation"
		self.session_box_navigation_next_id_3["parent_json_id"] = 1
		self.session_box_navigation_next_id_3["parent_name"] = "mode_1_id_1"
		self.session_box_navigation_prev_id_7 = {}
		self.session_box_navigation_prev_id_7["attached_to"] = "midi_note_ch_15_val_3"
		self.session_box_navigation_prev_id_7["module"] = "self"
		self.session_box_navigation_prev_id_7["element"] = "scroll_sess_offset"
		self.session_box_navigation_prev_id_7["output_type"] = "func"
		self.session_box_navigation_prev_id_7["func_arg"] = "cnfg"
		self.session_box_navigation_prev_id_7["tracks_scenes"] = "scenes"
		self.session_box_navigation_prev_id_7["ui_listener"] = "offset"
		self.session_box_navigation_prev_id_7["feedback_brain"] = "feedback_sessbox_nav"
		self.session_box_navigation_prev_id_7["ctrl_type"] = "decrement"
		self.session_box_navigation_prev_id_7["enc_first"] = 127
		self.session_box_navigation_prev_id_7["enc_second"] = 0
		self.session_box_navigation_prev_id_7["steps"] = 1
		self.session_box_navigation_prev_id_7["switch_type"] = "momentary"
		self.session_box_navigation_prev_id_7["LED_mapping_type_needs_feedback"] = "1"
		self.session_box_navigation_prev_id_7["LED_feedback"] = "default"
		self.session_box_navigation_prev_id_7["LED_feedback_active"] = "1"
		self.session_box_navigation_prev_id_7["LED_on"] = "127"
		self.session_box_navigation_prev_id_7["LED_off"] = "0"
		self.session_box_navigation_prev_id_7["LED_send_feedback_to_selected"] = ["midi_note_ch_15_val_3"]
		self.session_box_navigation_prev_id_7["json_id"] = 7
		self.session_box_navigation_prev_id_7["mapping_name"] = "Session Box Navigation PREV"
		self.session_box_navigation_prev_id_7["mapping_type"] = "Session Box Navigation"
		self.session_box_navigation_prev_id_7["parent_json_id"] = 1
		self.session_box_navigation_prev_id_7["parent_name"] = "mode_1_id_1"
		self.session_box_navigation_advance_id_5 = {}
		self.session_box_navigation_advance_id_5["attached_to"] = "midi_note_ch_15_val_2"
		self.session_box_navigation_advance_id_5["module"] = "self"
		self.session_box_navigation_advance_id_5["element"] = "scroll_sess_offset"
		self.session_box_navigation_advance_id_5["output_type"] = "func"
		self.session_box_navigation_advance_id_5["func_arg"] = "cnfg"
		self.session_box_navigation_advance_id_5["tracks_scenes"] = "scenes"
		self.session_box_navigation_advance_id_5["ui_listener"] = "offset"
		self.session_box_navigation_advance_id_5["feedback_brain"] = "feedback_sessbox_nav"
		self.session_box_navigation_advance_id_5["ctrl_type"] = "increment"
		self.session_box_navigation_advance_id_5["enc_first"] = 127
		self.session_box_navigation_advance_id_5["enc_second"] = 0
		self.session_box_navigation_advance_id_5["steps"] = 1
		self.session_box_navigation_advance_id_5["switch_type"] = "momentary"
		self.session_box_navigation_advance_id_5["LED_mapping_type_needs_feedback"] = "1"
		self.session_box_navigation_advance_id_5["LED_feedback"] = "default"
		self.session_box_navigation_advance_id_5["LED_feedback_active"] = "1"
		self.session_box_navigation_advance_id_5["LED_on"] = "127"
		self.session_box_navigation_advance_id_5["LED_off"] = "0"
		self.session_box_navigation_advance_id_5["LED_send_feedback_to_selected"] = ["midi_note_ch_15_val_2"]
		self.session_box_navigation_advance_id_5["json_id"] = 5
		self.session_box_navigation_advance_id_5["mapping_name"] = "Session Box Navigation Advance"
		self.session_box_navigation_advance_id_5["mapping_type"] = "Session Box Navigation"
		self.session_box_navigation_advance_id_5["parent_json_id"] = 1
		self.session_box_navigation_advance_id_5["parent_name"] = "mode_1_id_1"
	...
	def _mode1_ui_listeners(self):
		try:
			self._session.add_offset_listener(self.session_box_navigation_next_id_3_led_listener)
		except:
			self.log("_mode1_ui_listeners: self._session does not exist")
		try:
			self._session.add_offset_listener(self.session_box_navigation_prev_id_7_led_listener)
		except:
			self.log("_mode1_ui_listeners: self._session does not exist")
		try:
			self._session.add_offset_listener(self.session_box_navigation_advance_id_5_led_listener)
		except:
			self.log("_mode1_ui_listeners: self._session does not exist")
	def _remove_mode1_ui_listeners(self):
		try:
			self._session.remove_offset_listener(self.session_box_navigation_next_id_3_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: self._session does not exist")
		try:
			self._session.remove_offset_listener(self.session_box_navigation_prev_id_7_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: self._session does not exist")
		try:
			self._session.remove_offset_listener(self.session_box_navigation_advance_id_5_led_listener)
		except:
			self.log("remove__mode1_ui_listeners: self._session does not exist")
	def _mode1_fire_all_feedback(self):
		self.session_box_navigation_next_id_3_led_listener()
		self.session_box_navigation_prev_id_7_led_listener()
		self.session_box_navigation_advance_id_5_led_listener()
	def session_box_navigation_next_id_3_led_listener(self):
		self.feedback_brain(self.session_box_navigation_next_id_3)
	def session_box_navigation_prev_id_7_led_listener(self):
		self.feedback_brain(self.session_box_navigation_prev_id_7)
	def session_box_navigation_advance_id_5_led_listener(self):
		self.feedback_brain(self.session_box_navigation_advance_id_5)	
	################## CORE: Python 2.7 #################
	...
	def disconnect(self):
		...
		super(ATC_Operator, self).disconnect()